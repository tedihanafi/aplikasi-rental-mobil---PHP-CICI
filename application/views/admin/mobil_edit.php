    ...
    <?php foreach ($mobil as $m) { ?>
        <form action="<?php echo base_url() . 'admin/mobil_update' ?>" method="post">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="merk" value="<?php echo
                                                                            $m->mobil_merk; ?>">
                <?php echo form_error('merk'); ?>
            </div>
            <div class="form-group">
                <label>No. Plat Kendaraan</label>
                <input class="form-control" type="text" name="plat" value="<?php echo
                                                                            $m->mobil_plat; ?>">
            </div>
            <div class="form-group">
                <label>Warna</label>
                <input class="form-control" type="text" name="warna" value="<?php echo
                                                                            $m->mobil_warna; ?>">
            </div>
            <div class="form-group">
                <label>Tahun Kendaraan</label>
                <input class="form-control" type="text" name="tahun" value="<?php echo
                                                                            $m->mobil_tahun; ?>">
            </div>
            <div class="form-group">
